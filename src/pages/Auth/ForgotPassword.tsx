...
const ForgotPasswordPage = () => {
  ...
  return (
        <div className="bg-gray-100 dark:bg-darkbackgoundcolor min-h-screen flex items-center justify-center">
                <div className="max-w-4xl w-full bg-gray-50  dark:bg-darkacardcolor  rounded-r-lg shadow-md">
                    <div className='flex flex-col-reverse md:flex-row'>
                        ...
                        <div className="'flex-1 p-8">
                            <h2 className="text-2xl font-bold text-center text-newthemecolor">Forgot Password</h2>
                              <Form className="space-y-4"   onSubmit={(e) => { e.preventDefault(); validation.handleSubmit(); return false; }}>
                                ...
                                <button type='submit' className="w-full px-4 py-2 text-white bg-newthemecolor rounded-lg hover:bg-[#4536f1cf] focus:ring-4 focus:ring-blue-300" > Send Email </button>
                              </Form>
